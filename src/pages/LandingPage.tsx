  ...
  return (
      ...
      <div className='w-screen bg-[#F9F9F9] relative'>
           <div ref={sectionRef} id="home" className='header flex relative justify-center items-center z-2 h-[80vh] md:h-[95vh]'>
              ...
              <div className='container z-0 top-[25%] absolute flex flex-col justify-center items-center w-screen'>
           ...
           <div ref={sectionRef3} id="prices" className='pricing bg-[#EE426A] px-10 py-20 flex flex-col justify-center items-center'>
              ...
              <ul className='flex flex-col mt-10 md:flex-row gap-10'>
                <li>
                  <div className='slideInG3 rounded-[50px] bg-[#F9F9F9] py-10 px-5 flex flex-col items-center'>
              ...
              <div className='joinNow  pt-50 w-screen  draggable="false" flex flex-col justify-center items-center relative'>
                <p className='text-white text-4xl md:text-6xl z-1 text-center font-bold'>Start Planning Now!</p>
                <button className='bg-[#167DE5] px-10 py-5 rounded-[20px] mt-10 text-3xl font-bold text-white'><p>Sign Up Now</p></button>
              </div>
           </div>
